...
- [overview_forecast.json](overview_forecast.json)
...
- [overview_forecast2.json](overview_forecast2.json)


### 天気概況（週間）
- https://www.jma.go.jp/bosai/forecast/data/overview_week/130000.json
- [overview_week.json](overview_week.json)


### アメダス地点一覧
- https://www.jma.go.jp/bosai/amedas/const/amedastable.json
- [amedastable.json](amedastable.json)


### アメダス全地点データ
- https://www.jma.go.jp/bosai/amedas/data/map/20210224150000.json
